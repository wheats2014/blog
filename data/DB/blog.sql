...
--------
create TABLE admin(
    admin_id mediumint(8) not null auto_increment COMMENT '管理员ID',
...
create table module(
module_id mediumint(8) not null auto_increment COMMENT '模块ID',
module_name varchar(32) not null COMMENT '模块名称',
create_date datetime not null COMMENT '模块创建时间',
...
----------------------------
CREATE TABLE article (
 article_id smallint(5) NOT NULL AUTO_INCREMENT COMMENT '日志自增ID',
 article_name varchar(128) NOT NULL COMMENT '文章名称',
 article_time int(13) NOT NULL COMMENT '发布时间',
 article_ip varchar(15) NOT NULL COMMENT '发布IP',
 article_click int(10) NOT NULL COMMENT '查看人数',
...
article_file_id mediumint(8) not null auto_increment COMMENT '文章附件id',
article_file_name varchar(128) not null COMMENT '附件名称',
article_file_size bigint(11) not null COMMENT '文件大小 单位为kb',
article_file_path varchar(255) not null COMMENT '文件路径',
